        ...
        db.collection("products")
                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    ...
                    public void onSuccess(DocumentReference documentReference) {
                        ...
                        Toast.makeText(Fruits.this, "Product Successfully Added!", Toast.LENGTH_SHORT).show();
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(Fruits.this, "Error: Product not added!", Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    public void addFruitClick(View view) {
        ...
        try {
            ...
            if(!(productName.equals(""))){
                ...
                Toast.makeText(Fruits.this, "Missing Fields!", Toast.LENGTH_SHORT).show();
            }
        }catch (Exception e){
            Toast.makeText(Fruits.this, "Missing Fields!", Toast.LENGTH_SHORT).show();
        }
